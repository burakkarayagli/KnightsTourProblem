...
public class KnightsTour {
    ...
    public void general_search() {
        ...
        Runtime runtime = Runtime.getRuntime(); // memory
        ...
        String status = "No solution exists."; 
    ...
    public static void main(String[] args) {
        ...
        while (!search_method.equals("bfs") && !search_method.equals("dfs") && !search_method.equals("h1b") && !search_method.equals("h2")) {
